...
@onready var v_box_container = $MarginContainer/ScrollContainer/VBoxContainer
...
var stringDate = Time.get_datetime_string_from_datetime_dict(date, false)
...
func _on_button_pressed_pressed():
	print (date)
	print(stringDate)
